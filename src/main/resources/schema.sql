...
CREATE TABLE SUBJECT(
  SUBJECT_ID VARCHAR_IGNORECASE(128) PRIMARY KEY NULL UNIQUE,
);
...
CREATE TABLE PUBLIC_NOTE(
  PUBLIC_ID BIGINT AUTO_INCREMENT PRIMARY KEY UNIQUE,
  USER_ID BIGINT,
...
CREATE TABLE PRIVATE_NOTE(
    PRIVATE_ID BIGINT AUTO_INCREMENT PRIMARY KEY UNIQUE,
    USER_ID BIGINT,
    SUBJECT_ID VARCHAR(128),
    BODY CLOB NOT NULL
);
